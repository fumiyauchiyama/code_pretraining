...
mpirun -np $NUM_GPUS \
  ...
  train=train_shared preprocess.num_total_tokens=130000000 preprocess.select.num_total_samples=100000 train.batch_size=64 train.test_batch_size=64 \
  train.output_dir="/home/uchiyama.fumiya/ucllm/ucllm/program/outputs/models/exp1d"
