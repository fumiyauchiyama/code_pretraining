...
#$ -l h_rt=24:00:00
#$ -j y
#$ -o logs/exp005c/data_export_mini_upload/python/
#$ -cwd
...
python3 src/hf_fsdp_recipes/tools/upload_dataset.py \
  --path /groups/gcf51099/uchiyama.fumiya/ucllm/ucllm/program/outputs/data/data/python300000 \
  --name fumiyau/utllm-program-python-300k
