...
#$ -l h_rt=24:00:00
#$ -j y
#$ -N finetune_fld_gpt2_250m_haskell_lc
#$ -o logs/
#$ -cwd
...
python ./scripts/run_causal_prover.py  \
    ...
    --model_name_or_path /scratch/acc13097es/models/ucllm_program1709481344_haskell_500000/checkpoint-8000 \
    --tokenizer_name kmfoda/gpt2-250m \
    --output_dir outputs/ \
